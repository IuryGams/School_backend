-- CreateEnum
CREATE TYPE "Roles" AS ENUM ('ADMIN', 'COORDINATOR', 'TEACHER', 'STUDENT', 'PARENT');
...
-- AddForeignKey
ALTER TABLE "Tuition" ADD CONSTRAINT "Tuition_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "Parent"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
